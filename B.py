...
#DANGER(Parvez Ahmed Termux) Brand
...
def randBuildLSB():
    ...
    END = '[FBAN/FB4A;FBAV/148.0.0.94.498;FBBV/346484979;FBDM/{density=3.0,width=1080,height=2376};FBLC/en_GB;FBRV/47141262;FBCR/Zong;FBMF/INFINIX;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/Infinix X676C;FBSV/12;FBOP/19;FBCA/arm64-v8a:armeabi-v7a:armeabi;]'
    ua = f'Davik/2.1.0 (Linux; U; Android 12.0.1 {random.randint(4,13)}; {random.choice(model2)} Build/SP1A.210812.016.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
